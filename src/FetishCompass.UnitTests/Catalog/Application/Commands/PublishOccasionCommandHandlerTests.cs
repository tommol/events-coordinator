...
public class PublishOccasionCommandHandlerTests
{
    [Fact]
    public async Task Handle_OccasionExists_ChangesStatus()
    {
        ...
        var logger = Substitute.For<ILogger<PublishOccasionCommandHandler>>();
        var handler = new PublishOccasionCommandHandler(repo, logger);
        ...
        var command = new PublishOccasionCommand(occasion.Id);
    ...
    public async Task Handle_OccasionNotFound_ThrowsAndLogs()
    {
        ...
        var command = new PublishOccasionCommand((OccasionId)id);
