...
public class MarkOccasionAsReadyCommandHandlerTests
{
    [Fact]
    public async Task Handle_OccasionExists_ChangesStatus()
    {
        ...
        var logger = Substitute.For<ILogger<MarkOccasionAsReadyCommandHandler>>();
        var handler = new MarkOccasionAsReadyCommandHandler(repo, logger);
        ...
        var command = new MarkOccasionAsReadyCommand(occasion.Id);
    ...
    public async Task Handle_OccasionNotFound_ThrowsAndLogs()
    {
        ...
        var command = new MarkOccasionAsReadyCommand((OccasionId)id);
